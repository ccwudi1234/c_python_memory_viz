        ...
        <el-card class="code-editor-card">
          <template #header>
            <div class="card-header">
              <span>代码编辑器</span>
              <el-select v-model="language" style="width: 120px; margin-left: 10px">
...
import { VideoPlay, RefreshLeft, DocumentCopy, DArrowLeft, DArrowRight, Right } from '@element-plus/icons-vue'
